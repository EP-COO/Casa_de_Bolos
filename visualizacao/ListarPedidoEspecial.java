...
public class ListarPedidoEspecial {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ListarPedidoEspecial window = new ListarPedidoEspecial();
	...
	private void initialize() {
		...
		JMenuItem mntmListarClientes = new JMenuItem("Listar Pedido Bolo Especial");
