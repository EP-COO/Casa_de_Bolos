...
public class ListarBoloSimples {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ListarBoloSimples window = new ListarBoloSimples();
	...
	private void initialize() {
		...
		JMenuItem mntmListarClientes = new JMenuItem("Listar Bolo Simples");
