...
public class ListarBoloEspecial {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ListarBoloEspecial window = new ListarBoloEspecial();
	...
	private void initialize() {
		...
		JMenuItem mntmListarClientes = new JMenuItem("Listar Bolo Especial");
